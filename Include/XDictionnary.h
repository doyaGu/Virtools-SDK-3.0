...
public:
	...
	void	InsertSequence(const T* iSequence, const int iCount,void* iUserData = NULL)
	{
		_InsertSequence(m_Root,iSequence,iCount,iUserData);
	}
...
private:
	...
	void _InsertSequence(Node* iNode, const T* iSequence, const int iCount,void* iUserData)
	{
		Node* n = iNode;
