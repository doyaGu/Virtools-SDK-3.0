...
#define NTVI_PREALLOC		0x00000800 // Prealloc sub-childrens 
#define NTVI_OWNERDRAW		0x00001000 // Owner Drawn
...
typedef int (*MULTRITREESORTF)(const void* it1,const void* it2);
...
// Sub Item Functions 
	...
	void SetColumnSortFct(int col, MULTRITREESORTF sortf);
	void SetCurrentSortFct(MULTRITREESORTF sortf);
...
// Item Drawing	
	...
	void EnsureVisible(HNTVITEM it);
...
// Tree data :
	...
	MULTRITREESORTF m_SortFct;
	MULTRITREESORTF *m_SortFctArray;
