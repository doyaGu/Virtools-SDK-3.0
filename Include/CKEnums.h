...
typedef enum CK_BONES_REFERENTIAL {
	CK_BONE_LOCAL			=	0x00000000,	// Matrices transform from bones referential to skin holder referential
	CK_BONE_WORLD			,				// Matrices transform from bones referential to world referential
	CK_BONE_WORLDVIEW		,				// Matrices transform from bones referential to camera referential 
	CK_BONE_WORLDVIEWPROJ					// Same as CK_BONE_WORLDVIEW but concataned with the projection matrix
